...
const SignUp = () => {
  ...
  <div className="w-full max-w-4xl bg-transparent  backdrop-blur-lg  rounded-lg shadow-2xl  overflow-hidden flex flex-col p-2 ">
      <h2 className="text-[#1f2937] text-[30px] text-center font-bold mt-5 ">Sign Up</h2>
        ...
        <form className="space-y-5">
         ...
         <div>
          ...
          <SignUpButton Name={'SIGN UP'}  />
            ...
            <Link to="/Login" className="text-[#FF9900] hover:underline text-[14px] font-bold">Login</Link>
          </p>
            </div>
